export const otpTemplate = ({ email, otpCode, expiresInMinutes, purpose }) => {
    const emailContent = {
        signup: {
            subjectLine: "Verify Your Email to Get Started with StudyPlanner",
            actionText: "To complete your registration and start using StudyPlanner, please verify your email address using the code below:",
            subHeading: "Verification Code",
            footerNote: "If you did not sign up for StudyPlanner, you can safely ignore this email."
        },
        password_reset: {
            subjectLine: "Reset Your StudyPlanner Password",
        ...
        email_update: {
            subjectLine: "Confirm Your New Email for StudyPlanner",
            actionText: "To update your email address for your StudyPlanner account, please verify your new email using the code below:",
                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="margin: auto; background-color: #ffffff;" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td style="padding: 20px; text-align: center; background-color: #0a0a0a; color: #fafafa;" bgcolor="#0a0a0a" class="email-header">
                            <h1 style="margin: 0; font-size: 24px;">Study Planner</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px; color: #0a0a0a;">
                            ...
                            <p style="font-size: 13px; margin-top: 10px;">— The StudyPlanner Team</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px; text-align: center; background-color: #ffffff; border-top: 1px solid #e5e5e5; color: #0a0a0a;" bgcolor="#ffffff" class="email-footer">
                            ...
                            <p style="margin: 0; font-size: 12px;">© 2024 Study Planner. All rights reserved.</p>
                            <p style="margin: 8px 0 0 0; font-size: 11px; color: #737373;">Created by Divya Sachan</p>
                        </td>
                    </tr>
                </table>
            </td>
